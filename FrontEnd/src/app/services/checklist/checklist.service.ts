...
export class ChecklistService {
  ...
  // }
  getchecklist(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/getchecklist`, body);
  }
  ...
  // }
  getsinglechecklistcheckpoint(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/getsinglechecklistcheckpoint`, body);
  }
  ...
  // }
  getchecklistcheckpoint(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/getchecklistcheckpoint`, body);
  }
  ...
  getallchecklists(): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/getallchecklists`);
  }
  ...
  // }
  getmyAllChecklist(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/getmyAllChecklist`, body);
  }
  ...
  // }
  getpendingchecklistcheckpoint(): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/getpendingchecklistcheckpoint`);
  }
  ...
  // }
  getmypendingchecklistcheckpoint(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/getmypendingchecklistcheckpoint`, body);
  }
  ...
  // }
getrolependingchecklistcheckpoint(body: any): Observable<any> {
  return this.http.post<any>(`${this.apiUrl}/getrolependingchecklistcheckpoint`, body);
}
  ...
  // }
  addchecklist(body: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/addchecklist`, body);
  }
  ...
  // }
  deletechecklist(body: any): Observable<any> {
    return this.http.delete(`${this.apiUrl}/deletechecklist`, body);
  }
}
